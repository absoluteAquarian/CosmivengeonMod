...
namespace CosmivengeonMod{
	public class QuickReference{
		...
		public QuickReference(string name){
			modName = name;
		}

		public static implicit operator Mod(QuickReference reference) => reference.GetMod();
		...
		public static bool operator ==(Mod mod, QuickReference reference) => mod == reference.GetMod();

		public static bool operator !=(Mod mod, QuickReference reference) => mod != reference.GetMod();

		public override bool Equals(object obj)
			=> obj is QuickReference reference && instance == reference.instance;
