...
namespace CosmivengeonMod.Detours{
	public static class DetourProjectile{
		public static void Load(){
			On.Terraria.Projectile.StatusPlayer += HookStatusPlayer;
		}

		private static void HookStatusPlayer(On.Terraria.Projectile.orig_StatusPlayer orig, Projectile self, int i){
