...
namespace CosmivengeonMod.API.Edits {
	internal class DesolationModeBossContactDebuffsDetour : Edit {
		public override void LoadEdits() {
			On.Terraria.Player.StatusFromNPC += Player_StatusFromNPC;
		}
		...
		private static void Player_StatusFromNPC(On.Terraria.Player.orig_StatusFromNPC orig, Player self, NPC npc) {
