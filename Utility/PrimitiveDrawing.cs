...
namespace CosmivengeonMod.Utility{
	public static class PrimitiveDrawing{
		...
		public static void DrawHollowectangle(Vector2 coordTL, Vector2 coordBR, Color color){
		...
		public static void SubmitPacket(PrimitivePacket packet){
			...
			foreach(EffectPass pass in simpleVertexEffect.CurrentTechnique.Passes){
				pass.Apply();
