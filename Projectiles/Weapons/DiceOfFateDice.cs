...
namespace CosmivengeonMod.Projectiles.Weapons{
	public class DiceOfFateDice : ModProjectile{
		public override string Texture => "CosmivengeonMod/Items/Weapons/DiceOfFate";
		...
		public override void Kill(int timeLeft){
			...
			switch(random){
				...
				case 2:
					...
					switch(rollEvent){
						...
						case 2:
							...
							break;
						case 3:
							InformEveryone(CosmivengeonWorld.desoMode ? "Heavy fatigue and no mana!" : "No mana!");

							if(CosmivengeonWorld.desoMode){
								CosmivengeonPlayer mp = owner.GetModPlayer<CosmivengeonPlayer>();
				...
				case 6:
					...
					do{
						rollEvent = Main.rand.Next(0, 3);
					}while(rollEvent == 1 && !CosmivengeonWorld.desoMode);
					...
					switch(rollEvent){
						...
						case 1:
							...
							owner.GetModPlayer<CosmivengeonPlayer>().stamina.ForceExhaustion();
							break;
						case 2:
				...
				case 7:
					...
					switch(rollEvent){
						...
						case 1:
							...
							owner.GetModPlayer<DicePlayer>().SetFishModifier(detriment: true, Commands.TimeSetter._7_30PM_day + Commands.TimeSetter._4_30AM_night);
							break;
					}
					break;
				#endregion
				...
				case 13:
					...
					switch(rollEvent){
						...
						case 2:
							...
							owner.GetModPlayer<DicePlayer>().SetFishModifier(detriment: false, duration: Commands.TimeSetter._7_30PM_day + Commands.TimeSetter._4_30AM_night);
							break;
						case 3:
							int drop = Main.rand.Next(new int[]{
								ItemID.Aglet,
				...
				case 16:
					...
					switch(rollEvent){
						...
						case 3:
							...
							owner.GetModPlayer<DicePlayer>().SetShopModifier(good: true, duration: Commands.TimeSetter._7_30PM_day + Commands.TimeSetter._4_30AM_night);
							break;
						case 4:
				...
				case 18:
					...
					switch(rollEvent){
						...
						case 1:
							...
							owner.GetModPlayer<DicePlayer>().SetShopModifier(good: true,
								duration: Commands.TimeSetter._7_30PM_day + Commands.TimeSetter._4_30AM_night);
							break;
						case 2:
